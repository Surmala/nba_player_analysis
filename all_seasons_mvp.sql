...
ALTER TABLE nba_player_stats.all_seasons
RENAME COLUMN `MyUnknownColumn` TO `Player_id`;
...
-- Here in assist per game Mark Jackson is on the top
...
-- # player_name, season, pts_improvement, reb_improvement, ast_improvement, total_improvement
-- 'Skylar Mays', '2022', '12.4', '2.3', '7.7', '22.4'
-- we found in 2022 Skylar Mays has the top most improvement
...
# player_name, season, experience, experience_level
-- 'A.C. Green', '1996', '0', 'Rookie'
-- 'A.C. Green', '1997', '1', 'Mid-Level'
-- 'A.C. Green', '1998', '2', 'Mid-Level
-- 'A.C. Green', '1999', '3', 'Mid-Level' 